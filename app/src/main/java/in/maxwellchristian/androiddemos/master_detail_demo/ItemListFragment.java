package in.maxwellchristian.androiddemos.master_detail_demo;
...
import in.maxwellchristian.androiddemos.databinding.FragmentItemListBinding;
import in.maxwellchristian.androiddemos.databinding.ItemListContentBinding;
import in.maxwellchristian.androiddemos.master_detail_demo.placeholder.PlaceholderContent;
...
public class ItemListFragment extends Fragment {
    ...
    ViewCompat.OnUnhandledKeyEventListenerCompat
            unhandledKeyEventListenerCompat = (v, event) -> {
        if (event.getKeyCode() == KeyEvent.KEYCODE_Z && event.isCtrlPressed()) {
            ...
            return true;
        } else if (event.getKeyCode() == KeyEvent.KEYCODE_F &&
                event.isCtrlPressed()) {
            Toast.makeText(
                    v.getContext(),
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        ViewCompat.addOnUnhandledKeyEventListener(view,
                unhandledKeyEventListenerCompat);
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            ...
            holder.itemView.setOnLongClickListener(v -> {
                ...
                ClipData.Item clipItem =
                        new ClipData.Item(mValues.get(position).id);
